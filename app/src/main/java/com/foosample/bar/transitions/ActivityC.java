...
public class ActivityC extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exitTrans.setStartDelay(2000);
        getWindow().setExitTransition(exitTrans);

        Transition enterTrans = new Slide();
        enterTrans.setDuration(5000);
        enterTrans.setStartDelay(2000);
...
//        getWindow().setSharedElementEnterTransition(shared);
        ...
        Button button = (Button) findViewById(R.id.redView);
        button.setTransitionName("redView");
